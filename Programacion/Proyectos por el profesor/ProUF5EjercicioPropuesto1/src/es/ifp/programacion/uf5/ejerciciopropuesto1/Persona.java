...
/**
 * Clase raíz de la jerarquía que contiene los atributos comunes a las clases hijas
 * Alumno y Profesor.
 * Por composición se definen los datos de residencia en la clase Residencia.
 * 
 * No se permite la modificación de: nombre, primerApellido, segundoApellido y DNI.
 * 
 * @author juan
 *
 */
